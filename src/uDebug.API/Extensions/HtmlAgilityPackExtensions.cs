...
namespace HtmlAgilityPack
{
    public static class HtmlAgilityPackExtensions
    {
        ...
        public static IEnumerable<HtmlNode> GetElementsByClassName(this HtmlDocument document, string tagName, string className)
        {
            return document.DocumentNode.Descendants(tagName).Where(n => n.GetAttributeValue("class", "").Split(' ').Contains(className));
        }
